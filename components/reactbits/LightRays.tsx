...
/**
 * LightRays — adapted from React Bits (https://reactbits.dev/backgrounds/light-rays)
 * WebGL (ogl) shader background: rays radiating from an edge/corner, optionally
 * following the cursor. Only renders while the container is on-screen.
 */
